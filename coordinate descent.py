...
def gradient_descent(func_grad, init_point, step_size, num_iters):
    ...
    for i in range(num_iters):
        ...
        curr_iter = [a-b for a,b in zip(curr_iter,scaled_gradient)]
...
def coordinate_descent(func_grad_1d, init_point, step_size, num_iters,
    ...
    for i in range(num_iters):
        ...
        if choice == 'cyclic':
            ...
            coordinates = [i for i in range(len(init_point))]
        elif choice == 'random':
            # TASK 2.2.2
            ...
            coordinates = [i for i in random.randrange(0,len(init_point),1)]
        else:
...
def main():
    ...
    squared_loss = lambda B: loss_calculator(X,Y, loss['squared'], B)
    squared_loss_grad = lambda B: loss_grad_calculator(X, Y, loss_deriv['squared'], B)
    squared_loss_grad_1d = lambda B,j: loss_grad_1d_calculator(X, Y, loss_deriv['squared'], B, j)
    ...
    # along with the 3 functions: loss_calculator, loss_grad_calculator,
    # and loss_grad_1d_calculator
    logistic_loss = lambda B: loss_calculator(X,Y, loss['logistic'], B)
    logistic_loss_grad = lambda B: loss_grad_calculator(X, Y, loss_deriv['logistic'], B)
    logistic_loss_grad_1d = lambda B,j: loss_grad_1d_calculator(X, Y, loss_deriv['logistic'], B, j)
